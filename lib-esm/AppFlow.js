...
import { DeSelectNode, SelectingNodes, SelectNode, SelectOneMoreNode, SingleSelectionReturn, TurnOffMultiNodeSelectionMode, TurnOnMultiNodeSelectionMode } from "./AppFlow/SelectNode";
import { DeleteNodes, DeletingNodes, NodesDeleted } from "./AppFlow/DeleteNodes";
import { MoveDiagram, MoveNode, MovePort, DoubleTouchMove, PinchZoom, ReleaseDiagram, ReleaseNode, ReleasePort, Touched, TouchEnd, TouchMoveOnDiagram, TouchMoveOnNode, TouchMoveOnPort, TouchStart } from "./AppFlow/Touch";
var AppFlow = /** @class */ (function () {
    function AppFlow() {
    }
    AppFlow.init = function (controller) {
        new Builder().build(function (name) {
            switch (name) {
                case 'Idle':
