...
exports.AdjustingFocus = AdjustingFocus;
var DoubleClick = /** @class */ (function (_super) {
    ...
    DoubleClick.prototype.activate = function () {
        _super.prototype.activate.call(this);
        this.registerEventHandler(ViewEvents_1.EventType.DoubleClick, this.doubleClickFunc);
    };
    return DoubleClick;
}(State_1.Transition));
...
exports.FocusAdjustmentFinished = FocusAdjustmentFinished;
